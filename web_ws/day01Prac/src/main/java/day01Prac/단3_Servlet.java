...
//3단 정보를 제공하는 서블릿 만들기
//1. HttpServlet을 상속받은 클래스 만들기
//2. 약속된 메서드 service 오버라이드 - 응답내용 작성하기
...
@WebServlet("/dan3")
public class 단3_Servlet extends HttpServlet{
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
		
		//3단을 제공하기
		resp.setCharacterEncoding("utf-8");   //보내는 응답데이터를 utf-8 인코딩해서 클라이언트에 보내기
